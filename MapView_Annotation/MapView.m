...
- (id) initWithFrame:(CGRect) frame
{
	...
	if (self != nil)
    {
        ...
        /*
         ...
         MKCoordinateRegion regions = MKCoordinateRegionMakeWithDistance([mp coordinate] ,15000,15000);
         
         [mv setRegion:regions animated:YES];
...
- (void)mapView:(MKMapView *)mv didAddAnnotationViews:(NSArray *)views
{
    ...
    id<MKAnnotation> mp = [annotationView annotation];
        ...
        MKCoordinateRegion region = MKCoordinateRegionMakeWithDistance([mp coordinate] ,15000,15000);
